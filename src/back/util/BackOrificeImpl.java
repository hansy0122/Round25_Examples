...
public class BackOrificeImpl extends UnicastRemoteObject implements BackOrifice {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see back.util.BackOrifice#getContents(java.lang.String,
	 * java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see back.util.BackOrifice#setContents(java.lang.String,
	 * java.lang.String, java.lang.String)
	 */
	public boolean setContents(String path, String filename, String contents) throws RemoteException {
		// TODO Auto-generated method stub
		java.io.File f = new java.io.File(path, filename);
		if (!f.exists())
			return false;
		try {
			java.io.PrintWriter out = new java.io.PrintWriter(new java.io.BufferedWriter(new java.io.FileWriter(f)));
	...
	public StringBuffer getData(String path, String filename) throws RemoteException {
		java.io.File f = new java.io.File(path, filename);
		if (!f.exists())
			return null;
		StringBuffer sb = new StringBuffer();
